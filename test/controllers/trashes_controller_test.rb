...
class TrashesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trash" do
    assert_difference('Trash.count') do
      post trashes_url, params: { trash: { name: @trash.name, quantity: @trash.quantity, recycle_status: @trash.recycle_status } }
    end
  ...
  test "should update trash" do
    patch trash_url(@trash), params: { trash: { name: @trash.name, quantity: @trash.quantity, recycle_status: @trash.recycle_status } }
